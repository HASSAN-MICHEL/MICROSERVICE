...
import {
  ...
  listeRejete , voircompta , envoiProgrammation 
} from '../controllers/dossierController.js';
...
router.put("/dossiers/:id/envoyer-programmation" , envoiProgrammation);
router.get("/dossiers/a-verifier-compta" , voircompta);
